...
Formula.create(name:"I", text:"¿JURAIS POR DIOS Y POR LA PATRIA SOBRE ESTOS SANTOS EVANGELIOS ARREGLAR VUESTRA CONDUCTA A LOS DICTADOS DE LA MORAL, RESPETAR Y HACER RESPETAR LA CONSTITUCIÓN NACIONAL Y LAS LEYES DICTADAS POR LOS ÓRGANOS CONSTITUCIONALES Y PONER AL SERVICIO DE LA SOCIEDAD Y DE VUESTROS SEMEJANTES EL ARTE Y LA CIENCIA DE VUESTRA PROFESIÓN?\nSI ASÍ NO LO HICIEREIS, DIOS Y LA PATRIA OS LO DEMANDEN", code:1)
Formula.create(name:"II", text:"¿JURAIS POR DIOS Y POR LA PATRIA ARREGLAR VUESTRA CONDUCTA A LOS DICTADOS DE LA MORAL, RESPETAR Y HACER RESPETAR LA CONSTITUCIÓN NACIONAL Y LAS LEYES DICTADAS POR LOS ÓRGANOS CONSTITUCIONALES Y PONER AL SERVICIO DE LA SOCIEDAD Y DE VUESTROS SEMEJANTES EL ARTE Y LA CIENCIA DE VUESTRA PROFESIÓN?\NSI ASÍ NO LO HICIEREIS, DIOS Y LA PATRIA OS LO DEMANDEN", code: 2)
Formula.create(name:"III", text:"¿JURAIS POR LA PATRIA ARREGLAR VUESTRA CONDUCTA A LOS DICTADOS DE LA MORAL, RESPETAR Y HACER RESPETAR LA CONSTITUCIÓN NACIONAL Y LAS LEYES DICTADAS POR LOS ÓRGANOS CONSTITUCIONALES Y PONER AL SERVICIO DE LA SOCIEDAD Y DE VUESTROS SEMEJANTES EL ARTE Y LA CIENCIA DE VUESTRA PROFESIÓN?\NSI ASÍ NO LO HICIEREIS, LA PATRIA OS LO DEMANDE", code: 3)
Formula.create(name:"IV", text:"¿JURAIS POR VUESTRO HONOR ARREGLAR VUESTRA CONDUCTA A LOS DICTADOS DE LA MORAL, RESPETAR Y HACER RESPETAR LA CONSTITUCIÓN NACIONAL Y LAS LEYES DICTADAS POR LOS ÓRGANOS CONSTITUCIONALES Y PONER AL SERVICIO DE LA SOCIEDAD Y DE VUESTROS SEMEJANTES EL ARTE Y LA CIENCIA DE VUESTRA PROFESIÓN?\NSI ASÍ NO LO HICIEREIS, QUE VUESTRA CONCIENCIA OS LO DEMANDE", code: 4)
